...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-_h_9hqv2^e7th5%kkuy8ddpaf30y-n-et)ey&n+pihsh9y17qq')
...
INSTALLED_APPS = [
    ...
    # 'django.contrib.gis',  # For PostGIS support - commented out for development
...
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'messaging.channel_layers.DevelopmentChannelLayer',
        'CONFIG': {
            'capacity': 1500,
            'expiry': 60,
        },
...
#         'NAME': config('DB_NAME', default='urbany_db'),
...
# CORS Configuration Produccion (Despliegue)
